# Django settings for what_are_we_waiting_for project.
import os
import sys
...
SECRET_KEY = '_#xe&j0ixv_+!vp%()j$roke!73*yy@gjfdqa*nd=#%3jx9muj'
...
ROOT_URLCONF = 'what_are_we_waiting_for.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'what_are_we_waiting_for.wsgi.application'
...
COVERAGE_EXCLUDE_MODULES = ('what_are_we_waiting_for.migrations', 'what_are_we_waiting_for.tests',
                            'what_are_we_waiting_for.local_settings',
...
DEFAULT_DOMAIN = 'http://what_are_we_waiting_for.com/'
