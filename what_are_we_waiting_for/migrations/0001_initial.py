    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(related_name='created_what_are_we_waiting_for_allergies_subrecords', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ('drug_fk', models.ForeignKey(blank=True, to='opal.Drug', null=True)),
                ('patient', models.ForeignKey(to='opal.Patient')),
                ('updated_by', models.ForeignKey(related_name='updated_what_are_we_waiting_for_allergies_subrecords', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(related_name='created_what_are_we_waiting_for_demographics_subrecords', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ...
                ('updated_by', models.ForeignKey(related_name='updated_what_are_we_waiting_for_demographics_subrecords', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(related_name='created_what_are_we_waiting_for_diagnosis_subrecords', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ('episode', models.ForeignKey(to='opal.Episode')),
                ('updated_by', models.ForeignKey(related_name='updated_what_are_we_waiting_for_diagnosis_subrecords', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('received_timestamp', models.DateTimeField(null=True, blank=True)),
                ('requested', models.NullBooleanField()),
                ('received', models.NullBooleanField()),
                ('test_type_ft', models.CharField(default=b'', max_length=255, null=True, blank=True)),
                ('created_by', models.ForeignKey(related_name='created_what_are_we_waiting_for_imaging_subrecords', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ('episode', models.ForeignKey(to='opal.Episode')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('received', models.NullBooleanField()),
                ('test_type_ft', models.CharField(default=b'', max_length=255, null=True, blank=True)),
                ('created_by', models.ForeignKey(related_name='created_what_are_we_waiting_for_labtest_subrecords', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ('episode', models.ForeignKey(to='opal.Episode')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(related_name='created_what_are_we_waiting_for_location_subrecords', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ('episode', models.ForeignKey(to='opal.Episode')),
                ('updated_by', models.ForeignKey(related_name='updated_what_are_we_waiting_for_location_subrecords', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('condition_ft', models.CharField(default=b'', max_length=255, null=True, blank=True)),
                ('condition_fk', models.ForeignKey(blank=True, to='opal.Condition', null=True)),
                ('created_by', models.ForeignKey(related_name='created_what_are_we_waiting_for_pastmedicalhistory_subrecords', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ('episode', models.ForeignKey(to='opal.Episode')),
                ('updated_by', models.ForeignKey(related_name='updated_what_are_we_waiting_for_pastmedicalhistory_subrecords', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(related_name='created_what_are_we_waiting_for_patientconsultation_subrecords', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ('episode', models.ForeignKey(to='opal.Episode')),
                ('reason_for_interaction_fk', models.ForeignKey(blank=True, to='opal.PatientConsultationReasonForInteraction', null=True)),
                ('updated_by', models.ForeignKey(related_name='updated_what_are_we_waiting_for_patientconsultation_subrecords', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(related_name='created_what_are_we_waiting_for_specialistreview_subrecords', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ('episode', models.ForeignKey(to='opal.Episode')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(related_name='created_what_are_we_waiting_for_symptomcomplex_subrecords', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ('episode', models.ForeignKey(to='opal.Episode')),
                ('symptoms', models.ManyToManyField(related_name='symptoms', to='opal.Symptom', blank=True)),
                ('updated_by', models.ForeignKey(related_name='updated_what_are_we_waiting_for_symptomcomplex_subrecords', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(related_name='created_what_are_we_waiting_for_treatment_subrecords', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ('drug_fk', models.ForeignKey(blank=True, to='opal.Drug', null=True)),
                ('episode', models.ForeignKey(to='opal.Episode')),
                ...
                ('updated_by', models.ForeignKey(related_name='updated_what_are_we_waiting_for_treatment_subrecords', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, to='what_are_we_waiting_for.SpecialistType', null=True),
        ),
        migrations.AddField(
            model_name='specialistreview',
            name='updated_by',
            field=models.ForeignKey(related_name='updated_what_are_we_waiting_for_specialistreview_subrecords', blank=True, to=settings.AUTH_USER_MODEL, null=True),
        ),
        migrations.AddField(
            model_name='labtest',
            name='test_type_fk',
            field=models.ForeignKey(blank=True, to='what_are_we_waiting_for.LabTestType', null=True),
        ),
        migrations.AddField(
            model_name='labtest',
            name='updated_by',
            field=models.ForeignKey(related_name='updated_what_are_we_waiting_for_labtest_subrecords', blank=True, to=settings.AUTH_USER_MODEL, null=True),
        ),
        migrations.AddField(
            model_name='imaging',
            name='test_type_fk',
            field=models.ForeignKey(blank=True, to='what_are_we_waiting_for.ImagingTestType', null=True),
        ),
        migrations.AddField(
            model_name='imaging',
            name='updated_by',
            field=models.ForeignKey(related_name='updated_what_are_we_waiting_for_imaging_subrecords', blank=True, to=settings.AUTH_USER_MODEL, null=True),
        ),
    ]
